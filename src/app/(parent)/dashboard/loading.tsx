...
export default function ParentDashboardLoading() {
  return (
    <main>
      ...
      <Card data-slot="grade-progress-card" className="rounded-brand-md shadow-sm bg-white gap-4">
        <div className="px-(--card-spacing) flex flex-col gap-3">
          <Skeleton className="h-5 w-1/4" />
      ...
      <Card data-slot="session-history-card" className="rounded-brand-md shadow-sm bg-white gap-4">
        <div className="px-(--card-spacing) flex flex-col gap-3">
